...
@section('content')
    <x-form-section title="{{ $title }}">
        ...
        <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mt-2">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="text-muted">Email ini akan digunakan sebagai username</small>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="text-muted">Ubah jika ingin mengganti password</small>
            ...
            {{-- Row 6: Perner, Site, Layanan, Login ID --}}
            <div class="row mt-2">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="perner">Perner</label>
                        <input type="text" class="form-control @error('perner') is-invalid @enderror" id="perner"
                            name="perner" value="{{ old('perner') }}">
                        @error('perner') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('layanan') is-invalid @enderror" id="layanan"
