...
class UserRolePermissionSeeder extends Seeder
{
    ...
    public function createRole($user)
    {
        ...
        foreach ($permissions as $permission) {
            ...
            $permissionParameterQm =  $permission . ' ' . 'parameter-qm';
            $permissionPenilaianTapping =  $permission . ' ' . 'penilaian-tappings';
            $permissionPenilaianAgent =  $permission . ' ' . 'penilaian-agent';
            ...
            Permission::firstOrCreate(['name' => $permissionParameterQm]);
            Permission::firstOrCreate(['name' => $permissionPenilaianTapping]);
            Permission::firstOrCreate(['name' => $permissionPenilaianAgent]);
            ...
            $role_admin->givePermissionTo($permissionParameterQm);
            $role_admin->givePermissionTo($permissionPenilaianTapping);
            $role_admin->givePermissionTo($permissionPenilaianAgent);
